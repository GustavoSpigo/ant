...
if(isset($_POST['comment'])){
    ...
    while ($linha = mysql_fetch_array($alterar, MYSQL_ASSOC)) {
        ...
        mysql_query($sql = " UPDATE `entrega` SET `nota`=$nota,`comentarioProfessor`='$comment' 
...
<table style="width: 100%;height: 100%;">
    <tr>
        ...
        <td>
        	...
        	<pre><code class="xml">
        		<?php echo htmlentities( file_get_contents("/home/spigo594/public_html/trabalhos" . str_replace(';','',$row['files']))); ?>
        	</code></pre>
